...
class MiniCourt:
    ...
    def draw_mini_court(self,frames):
        ...
        Args:
            frames: list of frames on which the mini court will be drawn
    ...
    def get_start_point_of_mini_court(self):
        ...
        Returns:
            the start point of the mini court
        """
    ...
    def get_court_drawing_keypoints(self):
        """Get the key points of the mini court

        Returns:
            the key points of the mini court
        """
    ...
    def get_mini_court_coordinates(self,
        ...
        """Get the mini court coordinates of the player

        Args:
            object_position: the position of the player
            closest_key_point: the closest key point to the player
            closest_key_point_index: the index of the closest key point
            player_height_in_pixels: the height of the player in pixels
            player_height_in_meters: the height of the player in meters

        Returns:
            the mini court coordinates of the player
        """
        ...
        closest_mini_court_keypoint = (self.drawing_keypoints[closest_key_point_index*2],
    ...
    def convert_bounding_boxes_to_mini_court_coordinates(self,player_boxes, ball_boxes, original_court_key_points ):
        ...
        Args:
            player_boxes: the bounding boxes of the players
            ball_boxes: the bounding boxes of the ball
            original_court_key_points: the key points of the court

        Returns:
            the bounding boxes of the players and the ball in mini court coordinates
        """
        player_heights = {
    ...
    def draw_points_on_mini_court(self,frames,postions, color=(0,255,0)):
        ...
        Args:
            ...
            postions: the positions of the players and the ball
            color: the color of the points as a tuple (R,G,B), defaults to (0,255,0)
